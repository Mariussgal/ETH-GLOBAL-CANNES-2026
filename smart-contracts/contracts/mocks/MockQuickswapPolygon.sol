...
/// @notice Mock Polygon — frais USDC aléatoires, cooldown court, arrêt par `setFeesEnabled(false)`.
contract MockQuickswapPolygon {
    ...
    uint256 public minFeeUsdc = 1 * 1e5;
    uint256 public maxFeeUsdc = 25 * 1e6;
